...
par(mar = c(2.5, 3, 0.1, 0.1), mgp = c(1.5, 0.5, 0))
plot(cov_st~t_vec, type = "p", ylab = TeX(r'($Cor(W_p(5),W_p(x))$)'), xlab = "x", cex=2, ylim = c(0,1), cex.lab=font_size, cex.axis=axis_size,
)
...
legend(8, 0.6, legend=c("True", "k = 10", "k = 30", "k = 50", "k = 100"),
...
par(mar = c(2.5, 3, 0.1, 0.1), mgp = c(1.5, 0.5, 0))
plot(cov_st~t_vec, type = "p", ylab = TeX(r'($Cor(W_p(5),W_p(x))$)'), xlab = "x", cex = 2, ylim = c(0,1), xlim = c(0,15), cex.lab=font_size, cex.axis=axis_size,
)
lines(appr_cov_st1~t_vec, lty = 'dotted', col = "green", lwd = 4)
lines(appr_cov_st2~t_vec, lty = 'dashed', col = "brown", lwd = 2)
lines(appr_cov_st3~t_vec, lty = 'dotdash', col = "red", lwd = 2)
...
par(mar = c(2.5, 3, 0.1, 0.1), mgp = c(1.5, 0.5, 0))
plot(cross_cov_st~t_vec, type = "p", ylab = TeX(r'($Cor(W_p(5),W_p'(x))$)'), xlab = "x", cex = 2, ylim = c(0,1), cex.lab=font_size, cex.axis=axis_size,
)
...
legend(8, 0.4, legend=c("True", "k = 10", "k = 30", "k = 50", "k = 100"),
       col=c("black", "green", "brown", "red", "purple"), lty= c(NA, "dotted", "dashed", "dotdash", "solid"), 
       cex=1.5, box.lty = 0, lwd = 2,
       pch = c(1, NA, NA, NA, NA))
dev.off()
